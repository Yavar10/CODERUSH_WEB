  ...
  return isArcadeMode ? (
    ...
    <>
      <div
        ref={ringRef}
        style={{ borderColor: "#DF0024" }}
        className="fixed top-0 left-0 w-10 h-10 rounded-full border-2 pointer-events-none z-[99999] -translate-x-1/2 -translate-y-1/2 hidden md:block"
        aria-hidden="true"
      />
      ...
      <div
        ref={dotRef}
        style={{ backgroundColor: "#DF0024" }}
        className="fixed top-0 left-0 w-3 h-3 rounded-full pointer-events-none z-[100000] -translate-x-1/2 -translate-y-1/2 hidden md:block"
        aria-hidden="true"
      />
    </>
  );
